...
# ssm248计算机科学与技术学习网站的设计与开发+jsp

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=46)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本在校学习网站也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让作业信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，在校学习网站的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，在校学习网站是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此在校学习网站为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|8|jiaoan\_name|String|教案名称|是|
|9|jiaoan\_types|Integer|教案类型|是|
|10|jiaoan\_file|String|教案文件|是|
|11|jiaoan\_photo|String|教案图片|是|
|12|jiaoan\_content|String|教案详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|14|jiaoan\_id|Integer|教案|是|
|15|yonghu\_id|Integer|用户|是|
|16|insert\_time|Date|收藏时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|18|jiaoan\_id|Integer|教案|是|
|19|yonghu\_id|Integer|用户|是|
|20|jiaoan\_liuyan\_content|String|留言内容|是|
|21|reply\_content|String|回复内容|是|
|22|insert\_time|Date|留言时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|24|tongzhi\_name|String|通知名称|是|
|25|tongzhi\_types|Integer|通知类型|是|
|26|insert\_time|Date|通知时间|是|
|27|tongzhi\_content|String|通知详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|29|yonghu\_name|String|姓名|是|
|30|yonghu\_phone|String|手机号|是|
|31|yonghu\_id\_number|String|身份证号|是|
|32|yonghu\_photo|String|头像|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|35|zuoye\_id|Integer|作业|是|
|36|yonghu\_id|Integer|用户|是|
|37|yonghuzuoye\_file|String|回答作业|是|
|38|insert\_time|Date|回答作业时间|是|
|39|yonghuzuoye\_fenshu|Integer|分数|是|
|40|yonghuzuoye\_content|String|批改详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|42|zuoye\_name|String|作业名称|是|
|43|zuoye\_types|Integer|作业类型|是|
|44|zuoye\_file|String|作业文件|是|
|45|zuoye\_end\_time|Date|作业截止时间|是|
|46|zuoye\_photo|String|作业图片|是|
|47|zuoye\_content|String|作业详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|49|zuoye\_id|Integer|作业|是|
|50|yonghu\_id|Integer|用户|是|
|51|insert\_time|Date|收藏时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|53|zuoye\_id|Integer|作业|是|
|54|yonghu\_id|Integer|用户|是|
|55|zuoye\_liuyan\_content|String|留言内容|是|
|56|reply\_content|String|回复内容|是|
|57|insert\_time|Date|留言时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|59|news\_name|String|新闻名称|是|
|60|news\_types|Integer|新闻类型|是|
|61|news\_photo|String|新闻图片|是|
|62|insert\_time|Date|新闻时间|是|
|63|news\_content|String|新闻详情|是|
|64|create\_time|Date|创建时间|是|
表4.12管理员表表
...
图5.3 作业管理页面
### 5.1.4 作业类型管理
如图5.4显示的就是作业类型管理页面，此页面提供给管理员的功能有：新增类型,修改类型,删除类型。
...
## 5.2前台首页功能模块
` `在校学习网站，在在校学习网站可以查看教案,通知,作业,新闻、我的、跳转到后台等内容，如图5-17所示。
...
教案信息，在商品信息页面可以查看教案详细信息，如图5-19所示。 
